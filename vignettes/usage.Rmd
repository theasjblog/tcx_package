...
sp <- autoSplits(gpx)
doPlots(gpx, xVariable = "Time", doFacet = TRUE, sp = sp)
spReduced <- purgeSplits(sp, splitsToEliminate = c(1,3,5))
...
$$IF_{pace} = \frac{\frac{60}{NP}}{\frac{60}{FTP}} = \frac{FTP}{NP}$$
...
* My error. Altough I checked with all possible references, it is possible that there is some mistake in my equations. If you spot one, please let me know and I will fix it
